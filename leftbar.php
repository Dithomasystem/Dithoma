  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <ul>	
      <li class="start"> <a href="dashboard.php"> <i class="icon-custom-home"></i> <span class="title">Dashboard</span> <span class="selected"></span>  </a> 
          ...
          <li ><a href="get-quote.php"> <span class="fa fa-tasks"></span> Query</a></li>
          <li ><a href="create-ticket.php"><span class="fa fa-ticket"></span> Create Application Ticket</a></li>
          <li ><a href="view-tickets.php"><span class="fa fa-ticket"></span> View Ticket Status</a></li>
